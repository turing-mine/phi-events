...
if (exitCode == 0) {
    ...
    var nextEventStr = eventLogger();
    var nextEvent = JSON.parse(nextEventStr);
...
if (exitCode == 0) {
    ...
    var throttle = 60000;
    var countTestStr = eventLogger(throttle);
    var countTest = JSON.parse(countTestStr);
...
if (exitCode == 0) {
    ...
    eventLogger();
    var maxseries = 60000;
    var firstCountStr = eventLogger(maxseries);
    var firstCount = JSON.parse(firstCountStr);
